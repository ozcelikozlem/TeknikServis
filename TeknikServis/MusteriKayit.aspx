	...
	<div class="flex-section gtco-gray-bg" style="width: 138%">
	   <div>
        <div class="auto-style1">
                    ...
                    <tr>
                        <td class="auto-style5">AD:<asp:TextBox ID="TextBox7" runat="server" Height="24px"  ></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="auto-style5">SOYAD: <asp:TextBox ID="TextBox9" runat="server" Height="24px"></asp:TextBox></td>
                  
                   
                    </tr>
                    <tr>
                        <td class="auto-style5">TCNO:<asp:TextBox ID="TextBox10" runat="server" Height="24px"></asp:TextBox></td>
                       
                    </tr>
                    <tr>
                        <td class="auto-style5">EPOSTA: <asp:TextBox ID="TextBox11" runat="server" Height="24px"></asp:TextBox></td>
                       
                    </tr>
                     <tr>
                        <td class="auto-style5">TELEFON: <asp:TextBox ID="TextBox12" runat="server" Height="24px"></asp:TextBox></td>
                       
                    </tr>
                     <tr>
                        <td class="auto-style5">ADRES:<asp:TextBox ID="TextBox13" runat="server" Height="24px"></asp:TextBox></td>
