...
<head>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6 col-xs-6">
						...
						<div id="gtco-logo" class="text-right"><a href="yonetici.aspx">Teknik Servis Yönetim <em>.<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/TeknikServis/images/Login_out.png" OnClick="ImageButton1_Click" />
                            </em></a></div>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url('images/img_bg_4.jpg'); left: 0px; top: 0; width: 100%; height: 152px;" data-stellar-background-ratio="0.5">
		<div class="overlay" style="left: 0; right: 0; top: 0; bottom: -12px"></div>
		<div class="gtco-container">
