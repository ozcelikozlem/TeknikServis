...
<body>
	...
	<div id="head-top" style="position: absolute; width: 100%; top: 0; ">
		<div class="gtco-top">
			<div class="container-fluid">
				<div class="row">
						<div id="gtco-logo" class="text-right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="yonetici.aspx">Teknik Servis Yönetim<em>.</em></a>&nbsp;&nbsp;&nbsp;&nbsp;<asp:ImageButton ID="ImageButton1" runat="server" Height="39px" ImageUrl="~/TeknikServis/images/Login_out.png" OnClick="ImageButton1_Click" Width="42px" />&nbsp;&nbsp;&nbsp; </div>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url('images/img_bg_4.jpg'); left: 0px; top: 0; width: 100%; height: 242px;" data-stellar-background-ratio="0.5">
	...
	<div class="flex-section gtco-gray-bg">
	   <div>
        <div class="auto-style1">
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="TEKNIKSERVISID" DataSourceID="SqlDataSource4" AllowPaging="True" AllowSorting="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellPadding="4" CssClass="auto-style1" ForeColor="#333333" GridLines="None" Width="1137px">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <Columns>
                    <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" />
                    <asp:BoundField DataField="TEKNIKSERVISID" HeaderText="TEKNIKSERVISID" SortExpression="TEKNIKSERVISID" ReadOnly="True" />
            ...
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:ConnectionString5 %>" DeleteCommand="DELETE FROM &quot;TEKNIKSERVIS&quot; WHERE &quot;TEKNIKSERVISID&quot; = :original_TEKNIKSERVISID AND ((&quot;TEKNIKSERVISAD&quot; = :original_TEKNIKSERVISAD) OR (&quot;TEKNIKSERVISAD&quot; IS NULL AND :original_TEKNIKSERVISAD IS NULL)) AND ((&quot;TEKNIKSERVISSOYAD&quot; = :original_TEKNIKSERVISSOYAD) OR (&quot;TEKNIKSERVISSOYAD&quot; IS NULL AND :original_TEKNIKSERVISSOYAD IS NULL)) AND ((&quot;TEKNIKSERVISADRES&quot; = :original_TEKNIKSERVISADRES) OR (&quot;TEKNIKSERVISADRES&quot; IS NULL AND :original_TEKNIKSERVISADRES IS NULL)) AND ((&quot;TEKNIKSERVISTELEFON&quot; = :original_TEKNIKSERVISTELEFON) OR (&quot;TEKNIKSERVISTELEFON&quot; IS NULL AND :original_TEKNIKSERVISTELEFON IS NULL)) AND ((&quot;TEKNIKSERVISMAAS&quot; = :original_TEKNIKSERVISMAAS) OR (&quot;TEKNIKSERVISMAAS&quot; IS NULL AND :original_TEKNIKSERVISMAAS IS NULL))" InsertCommand="INSERT INTO &quot;TEKNIKSERVIS&quot; (&quot;TEKNIKSERVISID&quot;, &quot;TEKNIKSERVISAD&quot;, &quot;TEKNIKSERVISSOYAD&quot;, &quot;TEKNIKSERVISADRES&quot;, &quot;TEKNIKSERVISTELEFON&quot;, &quot;TEKNIKSERVISMAAS&quot;) VALUES (:TEKNIKSERVISID, :TEKNIKSERVISAD, :TEKNIKSERVISSOYAD, :TEKNIKSERVISADRES, :TEKNIKSERVISTELEFON, :TEKNIKSERVISMAAS)" OldValuesParameterFormatString="original_{0}" ProviderName="<%$ ConnectionStrings:ConnectionString5.ProviderName %>" SelectCommand="SELECT &quot;TEKNIKSERVISID&quot;, &quot;TEKNIKSERVISAD&quot;, &quot;TEKNIKSERVISSOYAD&quot;, &quot;TEKNIKSERVISADRES&quot;, &quot;TEKNIKSERVISTELEFON&quot;, &quot;TEKNIKSERVISMAAS&quot; FROM &quot;TEKNIKSERVIS&quot;" UpdateCommand="UPDATE &quot;TEKNIKSERVIS&quot; SET &quot;TEKNIKSERVISAD&quot; = :TEKNIKSERVISAD, &quot;TEKNIKSERVISSOYAD&quot; = :TEKNIKSERVISSOYAD, &quot;TEKNIKSERVISADRES&quot; = :TEKNIKSERVISADRES, &quot;TEKNIKSERVISTELEFON&quot; = :TEKNIKSERVISTELEFON, &quot;TEKNIKSERVISMAAS&quot; = :TEKNIKSERVISMAAS WHERE &quot;TEKNIKSERVISID&quot; = :original_TEKNIKSERVISID AND ((&quot;TEKNIKSERVISAD&quot; = :original_TEKNIKSERVISAD) OR (&quot;TEKNIKSERVISAD&quot; IS NULL AND :original_TEKNIKSERVISAD IS NULL)) AND ((&quot;TEKNIKSERVISSOYAD&quot; = :original_TEKNIKSERVISSOYAD) OR (&quot;TEKNIKSERVISSOYAD&quot; IS NULL AND :original_TEKNIKSERVISSOYAD IS NULL)) AND ((&quot;TEKNIKSERVISADRES&quot; = :original_TEKNIKSERVISADRES) OR (&quot;TEKNIKSERVISADRES&quot; IS NULL AND :original_TEKNIKSERVISADRES IS NULL)) AND ((&quot;TEKNIKSERVISTELEFON&quot; = :original_TEKNIKSERVISTELEFON) OR (&quot;TEKNIKSERVISTELEFON&quot; IS NULL AND :original_TEKNIKSERVISTELEFON IS NULL)) AND ((&quot;TEKNIKSERVISMAAS&quot; = :original_TEKNIKSERVISMAAS) OR (&quot;TEKNIKSERVISMAAS&quot; IS NULL AND :original_TEKNIKSERVISMAAS IS NULL))">
                <DeleteParameters>
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString5 %>" ProviderName="<%$ ConnectionStrings:ConnectionString5.ProviderName %>" SelectCommand="SELECT &quot;TEKNIKSERVISAD&quot;, &quot;TEKNIKSERVISSOYAD&quot;, &quot;TEKNIKSERVISADRES&quot;, &quot;TEKNIKSERVISTELEFON&quot;, &quot;TEKNIKSERVISMAAS&quot;, &quot;TEKNIKSERVISID&quot; FROM &quot;TEKNIKSERVIS&quot;"></asp:SqlDataSource>
