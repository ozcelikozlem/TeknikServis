<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="TeknikServis._default" %>
	...
	<div class="main-feature">
		...
		<div class="text-center">
			...
			<div class="wow bounceInUp" data-wow-offset="0" data-wow-delay="0.6s">
                <p>
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Servis Talep Et" class="btn btn-default" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Daha Fazla Bilgi" class="btn btn-default" />
                </p>
			</div>
